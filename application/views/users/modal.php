        ...
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input
                    type="text"
                    class="form-control"
                    :class="{'is-invalid': formValidate.firstname}"
                    name="firstname"
            ...
            <div class="form-group">
				...
				<input
					type="text"
					class="form-control"
					:class="{'is-invalid': formValidate.lastname}"
					name="lastname"
			...
			<div class="form-group">
				...
				<br>
					<div class="btn-group">
						<button
							class="btn btn-outline-dark fa fa-mars"
							:class="{'active':(newUser.gender == 'boy')}"
							@click.prevent="pickGender('boy')">
							Male</button>
						<button
							class="btn btn-outline-dark fa fa-venus"
							:class="{'active': (newUser.gender == 'girl')}"
							@click.prevent="pickGender('girl')">
							Female</button>
					</div>
			...
			<div class="form-group">
				...
				<input
					type="date"
					class="form-control"
					:class="{'is-invalid': formValidate.birthday}"
					name="birthday"
			...
			<div class="form-group">
				...
				<input type="file" id="image" ref="image" v-on:change="onChangeFileUpload()"/>
				<div class="invalid-feedback"  v-html="formValidate.image"></div>
			</div>
			</div>
			<div class="col-md-6">
				<div class="form-group">
					...
					<input
						type="text"
						class="form-control"
						:class="{'is-invalid': formValidate.email}"
						name="email"
					...
					<div class="form-group">
						...
						<input
							type="text"
							class="form-control"
							:class="{'is-invalid': formValidate.contact}"
							name="contact"
						...
						<div class="form-group">
							...
							<textarea
								cols="35"
								rows="5"
								:class="{'is-invalid': formValidate.address}"
								name="address"
	...
	<div slot="body" class="row">
		<div class="col-md-6">
			...
			<div class="form-group">
				...
				<br>
					<div class="btn-group">
						<button
							class="btn btn-outline-dark fa fa-mars"
							:class="{'active':(chooseUser.gender == 'boy')}"
							@click="changeGender('boy')">
							Male</button>
						<button
							class="btn btn-outline-dark fa fa-venus"
							:class="{'active': (chooseUser.gender == 'girl')}"
			...
			<div class="form-group">
				...
				<input type="hidden" name="old_image" v-model="chooseUser.image" />
			</div>
			<div class="col-md-6">
				<div class="form-group">
					<label>Email</label>
