...
var v = new Vue({
   el:'#app',
    data:{
        url:'http://localhost/unnur/civuejs/',
        addModal: false,
        editModal:false,
        deleteModal:false,
        users:[],
    ...
    methods:{
        ...
        imgProfil(value){
            return v.url+'assets/img/upload/'+value //for image gender sign in the table
        },
		...
		onChangeFileUpload(){
			this.file = this.$refs.image.files[0]?this.$refs.image.files[0]:'default.jpg';
		},
